...
export default function MainRecord() {
  ...
  const today = new Date().toISOString().split("T")[0]; // 例: "2025-06-04"
    ...
    <>
      <div className="ml-4 mt-4">
        ...
        <textarea
          ...
          className="outline-none w-150 h-150 bg-zinc-800 rounded-2xl p-4 resize-none overflow-auto hover:cursor-pointer hover:bg-white/30"
        ></textarea>
      </div>
      <div className="ml-4 mt-4">
